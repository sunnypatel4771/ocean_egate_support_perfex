...
class Recruitment_model extends App_Model
{
	...
	public function add_candidate($data, $file = "")
	{
		...
		if (isset($data['family_religion'])) {
			$family_religion = $data['family_religion'];
			unset($data['family_religion']);
		}
		...
		if (isset($data['family_position'])) {
			$family_position = $data['family_position'];
			unset($data['family_position']);
		}
		...
		if (isset($data['family_birthday'])) {
			$family_birthday = $data['family_birthday'];
			unset($data['family_birthday']);
		}
		...
		if (isset($data['final_academy_career'])) {
			$final_academy_career = $data['final_academy_career'];
			unset($data['final_academy_career']);
		}
		...
		if (isset($data['family_company'])) {
			$family_company = $data['family_company'];
			unset($data['family_company']);
		}
		...
		if (isset($data['basic_deduction'])) {
			$basic_deduction = $data['basic_deduction'];
			unset($data['basic_deduction']);
		}

		if (isset($data['child_bearing'])) {
			$child_bearing = $data['child_bearing'];
			unset($data['child_bearing']);
		}
		...
		if (isset($data['contact_number2'])) {
			$contact_number2 = $data['contact_number2'];
			unset($data['contact_number2']);
		}

		// Education Info

		if (isset($data['education_year'])) {
		...
		if (isset($data['edu_start_date'])) {
			$edu_start_date = $data['edu_start_date'];
			unset($data['edu_start_date']);
		}

		if (isset($data['edu_finish_date'])) {
			$edu_finish_date = $data['edu_finish_date'];
			unset($data['edu_finish_date']);
		}

		if (isset($data['edu_date'])) {
			$edu_date = $data['edu_date'];
			unset($data['edu_date']);
		}

		if (isset($data['valid_date'])) {
			$valid_date = $data['valid_date'];
			unset($data['valid_date']);
		}

		if (isset($data['edu_institution'])) {
			$edu_institution = $data['edu_institution'];
			unset($data['edu_institution']);
		}

		if (isset($data['completed_edu'])) {
			$completed_edu = $data['completed_edu'];
			unset($data['completed_edu']);
		}

		// School Info

		if (isset($data['enterance_date'])) {
			$enterance_date = $data['enterance_date'];
			unset($data['enterance_date']);
		}

		if (isset($data['graduation_date'])) {
			$graduation_date = $data['graduation_date'];
			unset($data['graduation_date']);
		}
		...
		if (isset($data['year_of_graduation'])) {
			$year_of_graduation = $data['year_of_graduation'];
			unset($data['year_of_graduation']);
		}

		if (isset($data['final_academic_career'])) {
			$final_academic_career = $data['final_academic_career'];
			unset($data['final_academic_career']);
		}

		if (isset($data['academic_career_type'])) {
			$academic_career_type = $data['academic_career_type'];
			unset($data['academic_career_type']);
		}
		...
		// Reward Info
		if (isset($data['app_date'])) {
			$app_date = $data['app_date'];
			unset($data['app_date']);
		}

		if (isset($data['award_punishment'])) {
			$award_punishment = $data['award_punishment'];
			unset($data['award_punishment']);
		}

		if (isset($data['award_punishment_kind'])) {
			$award_punishment_kind = $data['award_punishment_kind'];
			unset($data['award_punishment_kind']);
		}

		if (isset($data['award_punishment_reason'])) {
			$award_punishment_reason = $data['award_punishment_reason'];
			unset($data['award_punishment_reason']);
		}

		if (isset($data['grade_rank_reward'])) {
			$grade_rank_reward = $data['grade_rank_reward'];
			unset($data['grade_rank_reward']);
		}

		if (isset($data['rewards_remark'])) {
			$rewards_remark = $data['rewards_remark'];
			unset($data['rewards_remark']);
		}

		// Medical Info

		if (isset($data['medical_test_date'])) {
			$medical_test_date = $data['medical_test_date'];
			unset($data['medical_test_date']);
		}

		if (isset($data['valid_test_date'])) {
			$valid_test_date = $data['valid_test_date'];
			unset($data['valid_test_date']);
		}

		if (isset($data['medical_test_division'])) {
			$medical_test_division = $data['medical_test_division'];
			unset($data['medical_test_division']);
		}

		if (isset($data['judgement_y_n'])) {
			$judgement_y_n = $data['judgement_y_n'];
			unset($data['judgement_y_n']);
		}

		if (isset($data['medical_hospital'])) {
			$medical_hospital = $data['medical_hospital'];
			unset($data['medical_hospital']);
		}

		if (isset($data['judgement'])) {
			$judgement = $data['judgement'];
			unset($data['judgement']);
		}

		if (isset($data['final_option'])) {
			$final_option = $data['final_option'];
			unset($data['final_option']);
		}

		if (isset($data['medical_remark'])) {
			$medical_remark = $data['medical_remark'];
			unset($data['medical_remark']);
		}

		// Promotion Info

		if (isset($data['promotion_app_date'])) {
			$promotion_app_date = $data['promotion_app_date'];
			unset($data['promotion_app_date']);
		}

		if (isset($data['final_grade'])) {
			$final_grade = $data['final_grade'];
			unset($data['final_grade']);
		}

		if (isset($data['promotion_grade'])) {
			$promotion_grade = $data['promotion_grade'];
			unset($data['promotion_grade']);
		}

		if (isset($data['final_depart'])) {
			$final_depart = $data['final_depart'];
			unset($data['final_depart']);
		}

		if (isset($data['length_of_stay'])) {
			$length_of_stay = $data['length_of_stay'];
			unset($data['length_of_stay']);
		}

		// Licence Info

		if (isset($data['lic_issue_authority'])) {
			$lic_issue_authority = $data['lic_issue_authority'];
			unset($data['lic_issue_authority']);
		}

		if (isset($data['lic_kind_division'])) {
			$lic_kind_division = $data['lic_kind_division'];
			unset($data['lic_kind_division']);
		}

		if (isset($data['lic_licence_no'])) {
			$lic_licence_no = $data['lic_licence_no'];
			unset($data['lic_licence_no']);
		}

		if (isset($data['lic_acquisition_date'])) {
			$lic_acquisition_date = $data['lic_acquisition_date'];
			unset($data['lic_acquisition_date']);
		}

		if (isset($data['lic_exipiry_date'])) {
			$lic_exipiry_date = $data['lic_exipiry_date'];
			unset($data['lic_exipiry_date']);
		}
		...
		if (isset($data['licence_remark'])) {
			$licence_remark = $data['licence_remark'];
			unset($data['licence_remark']);
		}

		// Document info

		if (isset($data['doc_kind_division'])) {
			$doc_kind_division = $data['doc_kind_division'];
			unset($data['doc_kind_division']);
		}

		if (isset($data['doc_licence_no'])) {
			$doc_licence_no = $data['doc_licence_no'];
			unset($data['doc_licence_no']);
		}

		if (isset($data['doc_issue_date'])) {
			$doc_issue_date = $data['doc_issue_date'];
			unset($data['doc_issue_date']);
		}

		if (isset($data['doc_exipiry_date'])) {
			$doc_exipiry_date = $data['doc_exipiry_date'];
			unset($data['doc_exipiry_date']);
		}

		if (isset($data['doc_issue_authority'])) {
			$doc_issue_authority = $data['doc_issue_authority'];
			unset($data['doc_issue_authority']);
		}

		if (isset($data['doc_remark'])) {
			$doc_remark = $data['doc_remark'];
			unset($data['doc_remark']);
		}

		//On Board Company

		if (isset($data['vessel_name_company'])) {
			$vessel_name_company = $data['vessel_name_company'];
			unset($data['vessel_name_company']);
		}

		if (isset($data['cur_onboard'])) {
			$cur_onboard = $data['cur_onboard'];
			unset($data['cur_onboard']);
		}

		if (isset($data['grade_rank_board'])) {
			$grade_rank_board = $data['grade_rank_board'];
			unset($data['grade_rank_board']);
		}
		if (isset($data['company_rank'])) {
			$company_rank = $data['company_rank'];
			unset($data['company_rank']);
		}
		if (isset($data['vessel_type_company'])) {
			$vessel_type_company = $data['vessel_type_company'];
			unset($data['vessel_type_company']);
		}
		if (isset($data['gross_ton_company'])) {
			$gross_ton_company = $data['gross_ton_company'];
			unset($data['gross_ton_company']);
		}
		if (isset($data['engine_type_company'])) {
			$engine_type_company = $data['engine_type_company'];
			unset($data['engine_type_company']);
		}
		if (isset($data['eng_output_company'])) {
			$eng_output_company = $data['eng_output_company'];
			unset($data['eng_output_company']);
		}

		if (isset($data['embarkation_other_date'])) {
			$embarkation_other_date = $data['embarkation_other_date'];
			unset($data['embarkation_other_date']);
		}
		if (isset($data['disembarkation_other_date'])) {
			$disembarkation_other_date = $data['disembarkation_other_date'];
			unset($data['disembarkation_other_date']);
		}
		
		if (isset($data['boarding_other_period'])) {
			$boarding_other_period = $data['boarding_other_period'];
			unset($data['boarding_other_period']);
		}
		if (isset($data['ramaining_days'])) {
			$ramaining_days = $data['ramaining_days'];
			unset($data['ramaining_days']);
		}
		if (isset($data['calculation_y_n'])) {
			$calculation_y_n = $data['calculation_y_n'];
			unset($data['calculation_y_n']);
		}
		...
		if (isset($data['ship_owner'])) {
			$ship_owner = $data['ship_owner'];
			unset($data['ship_owner']);
		}
		if (isset($data['employer_on_borad'])) {
			$employer_on_borad = $data['employer_on_borad'];
			unset($data['employer_on_borad']);
		}

		// on board other company

		if (isset($data['other_rank'])) {
			$other_rank = $data['other_rank'];
			unset($data['other_rank']);
		}
		if (isset($data['company_name_other'])) {
			$company_name_other = $data['company_name_other'];
			unset($data['company_name_other']);
		}

		if (isset($data['cur_other_onboard'])) {
			$cur_other_onboard = $data['cur_other_onboard'];
			unset($data['cur_other_onboard']);
		}

		if (isset($data['vessel_name_other'])) {
			$vessel_name_other = $data['vessel_name_other'];
			unset($data['vessel_name_other']);
		}
		if (isset($data['vessel_type_other'])) {
			$vessel_type_other = $data['vessel_type_other'];
			unset($data['vessel_type_other']);
		}
		if (isset($data['gross_ton_other'])) {
			$gross_ton_other = $data['gross_ton_other'];
			unset($data['gross_ton_other']);
		}
		if (isset($data['engine_type_other'])) {
			$engine_type_other = $data['engine_type_other'];
			unset($data['engine_type_other']);
		}
		if (isset($data['eng_output_other'])) {
			$eng_output_other = $data['eng_output_other'];
			unset($data['eng_output_other']);
		}
		if (isset($data['sailing_area'])) {
			$sailing_area = $data['sailing_area'];
			unset($data['sailing_area']);
		}
		if (isset($data['embarkation_date'])) {
			$embarkation_date = $data['embarkation_date'];
			unset($data['embarkation_date']);
		}
		if (isset($data['disembarkation_date'])) {
			$disembarkation_date = $data['disembarkation_date'];
			unset($data['disembarkation_date']);
		}
		if (isset($data['boarding_period'])) {
			$boarding_period = $data['boarding_period'];
			unset($data['boarding_period']);
		}
		if (isset($data['approval_rate'])) {
			$approval_rate = $data['approval_rate'];
			unset($data['approval_rate']);
		}
		...
		//on board In Land
		if (isset($data['company_name_land'])) {
			$company_name_land = $data['company_name_land'];
			unset($data['company_name_land']);
		}
		...
		if (isset($data['resignation_date'])) {
			...
			unset($data['resignation_date']);
		}
		if (isset($data['work_dep'])) {
			$work_dep = $data['work_dep'];
			unset($data['work_dep']);
		}
		if (isset($data['responsibility_work'])) {
			$responsibility_work = $data['responsibility_work'];
			unset($data['responsibility_work']);
		}
		if (isset($data['final_position'])) {
			$final_position = $data['final_position'];
			unset($data['final_position']);
		}
		if (isset($data['retire_reason'])) {
			$retire_reason = $data['retire_reason'];
			unset($data['retire_reason']);
		}
		if (isset($data['other_company_career'])) {
			$other_company_career = $data['other_company_career'];
			unset($data['other_company_career']);
		}
		if (isset($data['on_board_remark'])) {
			$on_board_remark = $data['on_board_remark'];
			unset($data['on_board_remark']);
		}

		// PSC

		if (isset($data['psc_date'])) {
			$psc_date = $data['psc_date'];
			unset($data['psc_date']);
		}
		...
		if (isset($data['deficiency'])) {
			$deficiency = $data['deficiency'];
			unset($data['deficiency']);
		}
		...
		if (isset($data['flag_kind_division'])) {
			$flag_kind_division = $data['flag_kind_division'];
			unset($data['flag_kind_division']);
		}

		if (isset($data['flag_licence_no'])) {
			$flag_licence_no = $data['flag_licence_no'];
			unset($data['flag_licence_no']);
		}

		if (isset($data['flag_issue_date'])) {
			$flag_issue_date = $data['flag_issue_date'];
			unset($data['flag_issue_date']);
		}

		if (isset($data['flag_exipiry_date'])) {
			$flag_exipiry_date = $data['flag_exipiry_date'];
			unset($data['flag_exipiry_date']);
		}

		if (isset($data['flag_issue_authority'])) {
			$flag_issue_authority = $data['flag_issue_authority'];
			unset($data['flag_issue_authority']);
		}

		if (isset($data['flag_remark'])) {
			$flag_remark = $data['flag_remark'];
			unset($data['flag_remark']);
		}

		if (isset($data['flag_attach_file_name'])) {
			unset($data['flag_attach_file_name']);
		}
		...
		if ($insert_id) {
			...
			foreach ($family_birthday as $key => $val) {
				if ($family_birthday[$key] != '') {

					if (!$this->check_format_date($val)) {
						$val = to_sql_date($val);
					}

					if (!$this->check_format_date($family_birthday[$key])) {
						$family_birthday[$key] = to_sql_date($family_birthday[$key]);
					}


					$this->db->insert(db_prefix() . 'rec_family', [
						'candidate' => $insert_id,
						'family_religion' => $family_religion[$key],
						'family_name' => $family_name[$key],
						'position' => $family_position[$key],
						'id_no' => $id_no[$key],
						'birthday' => $family_birthday[$key],
						'age' => $age[$key],
						'final_academy_career' => $final_academy_career[$key],
						'school' => $school[$key],
						'major' => $major[$key],
						'company' => $family_company[$key],
						'grade' => $grade[$key],
						'basic_deduction' => $basic_deduction[$key],
						'child_bearing' => $child_bearing[$key],
						'contact_number' => $contact_number[$key],
						'contact_number2' => $contact_number2[$key],
					]);
				}
			}

			foreach ($edu_start_date as $key => $val) {
				if ($edu_start_date[$key] != '') {

					if (!$this->check_format_date($val)) {
						$val = to_sql_date($val);
					}

					if (!$this->check_format_date($edu_start_date[$key])) {
						$edu_start_date[$key] = to_sql_date($edu_start_date[$key]);
					}

					if (!$this->check_format_date($edu_finish_date[$key])) {
						$edu_finish_date[$key] = to_sql_date($edu_finish_date[$key]);
					}

					if (!$this->check_format_date($edu_date[$key])) {
						$edu_date[$key] = to_sql_date($edu_date[$key]);
					}

					if (!$this->check_format_date($valid_date[$key])) {
						$valid_date[$key] = to_sql_date($valid_date[$key]);
					}

					$this->db->insert(db_prefix() . 'rec_education', [
						'candidate' => $insert_id,
						'year' => $education_year[$key],
						'course_type' => $course_type[$key],
						'course_name' => $course_name[$key],
						'edu_start_date' => $edu_start_date[$key],
						'edu_finish_date' => $edu_finish_date[$key],
						'edu_date' => $edu_date[$key],
						'valid_date' => $valid_date[$key],
						'edu_institution' => $edu_institution[$key],
						'completed_edu' => $completed_edu[$key],
					]);
				}
			}

			foreach ($enterance_date as $key => $val) {
				if ($enterance_date[$key] != '') {

					if (!$this->check_format_date($val)) {
						$val = to_sql_date($val);
					}

					if (!$this->check_format_date($enterance_date[$key])) {
						$enterance_date[$key] = to_sql_date($enterance_date[$key]);
					}

					if (!$this->check_format_date($graduation_date[$key])) {
						$graduation_date[$key] = to_sql_date($graduation_date[$key]);
					}
					...
					$this->db->insert(db_prefix() . 'rec_school', [
						'candidate' => $insert_id,
						'enterance_date' => $enterance_date[$key],
						'graduation_date' => $graduation_date[$key],
						'university' => $university[$key],
						'school_name' => $school_name[$key],
						'faculty' => $faculty[$key],
						'major_name' => $major_name[$key],
						'year_of_graduation' => $year_of_graduation[$key],
						'final_academic_career' => $final_academic_career[$key],
						'academic_career_type' => $academic_career_type[$key],
						'remark' => $remark[$key],
					]);
				}
			}

			foreach ($promotion_app_date as $key => $val) {
				if ($promotion_app_date[$key] != '') {

					if (!$this->check_format_date($val)) {
						$val = to_sql_date($val);
					}

					if (!$this->check_format_date($promotion_app_date[$key])) {
						$promotion_app_date[$key] = to_sql_date($promotion_app_date[$key]);
					}

					$this->db->insert(db_prefix() . 'rec_promotion', [
						'candidate' => $insert_id,
						'app_date' => $promotion_app_date[$key],
						'final_grade' => $final_grade[$key],
						'promotion_grade' => $promotion_grade[$key],
						'final_depart' => $final_depart[$key],
						'length_of_stay' => $length_of_stay[$key],
					]);
				}
			}

			foreach ($psc_date as $key => $val) {
				if ($psc_date[$key] != '') {
					...
					if (!$this->check_format_date($psc_date[$key])) {
						$psc_date[$key] = to_sql_date($psc_date[$key]);
					}
					...
					$this->db->insert(db_prefix() . 'rec_psc', [
						...
						'port' => $port[$key],
						'result' => $result[$key],
						'deficiency' => $deficiency[$key],
					]);
				}
			}


			foreach ($app_date as $key => $val) {
				if ($app_date[$key] != '') {
					...
					if (!$this->check_format_date($app_date[$key])) {
						$app_date[$key] = to_sql_date($app_date[$key]);
					}

					$rewardfileDir = RECRUITMENT_MODULE_UPLOAD_FOLDER . '/candidate/reward_file/';

					if (!empty($file['reward_file']['tmp_name'][$key]) && $file['reward_file']['tmp_name'][$key] != '') {
						$tmpFilePath = $file['reward_file']['tmp_name'][$key];
						_maybe_create_upload_path($rewardfileDir);
						$filename = unique_filename($rewardfileDir, $file['reward_file']['name'][$key]);
						$newFilePath = $rewardfileDir . $filename;

						if (move_uploaded_file($tmpFilePath, $newFilePath)) {
							$CI = &get_instance();
							// Insert data into the database for the current file
							$this->db->insert(db_prefix() . 'rec_reward', [
								'candidate' => $insert_id,
								'app_date' => $app_date[$key],
								'grade_rank' => $grade_rank_reward[$key],
								'award_punishment' => $award_punishment[$key],
								'award_punishment_kind' => $award_punishment_kind[$key],
								'award_punishment_reason' => $award_punishment_reason[$key],
								'reward_file' => $filename, // Insert filename directly
								'rewards_remark' => $rewards_remark[$key],
							]);
						}
					} else {
							$CI = &get_instance();
			...
			foreach ($lic_acquisition_date as $key => $val) {
				if ($lic_acquisition_date[$key] != '') {

					if (!$this->check_format_date($val)) {
						$val = to_sql_date($val);
					}

					if (!$this->check_format_date($lic_acquisition_date[$key])) {
						$lic_acquisition_date[$key] = to_sql_date($lic_acquisition_date[$key]);
					}

					if (!$this->check_format_date($lic_exipiry_date[$key])) {
						$lic_exipiry_date[$key] = to_sql_date($lic_exipiry_date[$key]);
					}
					...
					if (!empty($file['licence_attach_file']['tmp_name'][$key]) && $file['licence_attach_file']['tmp_name'][$key] != '') {
						$tmpFilePath = $file['licence_attach_file']['tmp_name'][$key];
						_maybe_create_upload_path($LicencefileDir);
						$filename = unique_filename($LicencefileDir, $file['licence_attach_file']['name'][$key]);
						...
						if (move_uploaded_file($tmpFilePath, $newFilePath)) {
							...
							$this->db->insert(db_prefix() . 'rec_licence', [
								'candidate' => $insert_id,
								'kind_division' => $lic_kind_division[$key],
								'licence_no' => $lic_licence_no[$key],
								'acquisition_date' => $lic_acquisition_date[$key],
								'exipiry_date' => $lic_exipiry_date[$key],
								'issue_authority' => $lic_issue_authority[$key],
								'attach_file' => $filename,
								'remark' => $licence_remark[$key],
							]);
						}
					} else {
							$CI = &get_instance();
			...
			foreach ($doc_issue_date as $key => $val) {
				if ($doc_issue_date[$key] != '') {

					if (!$this->check_format_date($val)) {
						$val = to_sql_date($val);
					}

					if (!$this->check_format_date($doc_issue_date[$key])) {
						$doc_issue_date[$key] = to_sql_date($doc_issue_date[$key]);
					}

					if (!$this->check_format_date($doc_exipiry_date[$key])) {
						$doc_exipiry_date[$key] = to_sql_date($doc_exipiry_date[$key]);
					}

					$documentfileDir = RECRUITMENT_MODULE_UPLOAD_FOLDER . '/candidate/document_file/';

					if (!empty($file['doc_attach_file']['tmp_name'][$key]) && $file['doc_attach_file']['tmp_name'][$key] != '') {
						$tmpFilePath = $file['doc_attach_file']['tmp_name'][$key];
						_maybe_create_upload_path($documentfileDir);
						$filename = unique_filename($documentfileDir, $file['doc_attach_file']['name'][$key]);
						...
						if (move_uploaded_file($tmpFilePath, $newFilePath)) {
							...
							$this->db->insert(db_prefix() . 'rec_document', [
								'candidate' => $insert_id,
								'kind_division' => $doc_kind_division[$key],
								'licence_no' => $doc_licence_no[$key],
								'issue_date' => $doc_issue_date[$key],
								'exipiry_date' => $doc_exipiry_date[$key],
								'issue' => $doc_issue_authority[$key],
								'attach_file' => $filename,
								'remark' => $doc_remark[$key],
							]);
						}
					} else {
							$CI = &get_instance();
			...
			foreach ($flag_issue_date as $key => $val) {
				if ($flag_issue_date[$key] != '') {

					if (!$this->check_format_date($val)) {
						$val = to_sql_date($val);
					}

					if (!$this->check_format_date($flag_issue_date[$key])) {
						$flag_issue_date[$key] = to_sql_date($flag_issue_date[$key]);
					}

					if (!$this->check_format_date($flag_exipiry_date[$key])) {
						$flag_exipiry_date[$key] = to_sql_date($flag_exipiry_date[$key]);
					}

					$flagfileDir = RECRUITMENT_MODULE_UPLOAD_FOLDER . '/candidate/flag_file/';

					if (!empty($file['flag_attach_file']['tmp_name'][$key]) && $file['flag_attach_file']['tmp_name'][$key] != '') {
						$tmpFilePath = $file['flag_attach_file']['tmp_name'][$key];
						_maybe_create_upload_path($flagfileDir);
						$filename = unique_filename($flagfileDir, $file['flag_attach_file']['name'][$key]);
						...
						if (move_uploaded_file($tmpFilePath, $newFilePath)) {
							...
							$this->db->insert(db_prefix() . 'rec_flag', [
								'candidate' => $insert_id,
								'kind_division' => $flag_kind_division[$key],
								'licence_no' => $flag_licence_no[$key],
								'issue_date' => $flag_issue_date[$key],
								'exipiry_date' => $flag_exipiry_date[$key],
								'issue' => $flag_issue_authority[$key],
								'attach_file' => $filename,
								'remark' => $flag_remark[$key],
							]);
						}
					} else {
							$CI = &get_instance();
			...
			foreach ($medical_test_date as $key => $val) {
				if ($medical_test_date[$key] != '') {

					if (!$this->check_format_date($val)) {
						$val = to_sql_date($val);
					}

					if (!$this->check_format_date($medical_test_date[$key])) {
						$medical_test_date[$key] = to_sql_date($medical_test_date[$key]);
					}

					if (!$this->check_format_date($valid_test_date[$key])) {
						$valid_test_date[$key] = to_sql_date($valid_test_date[$key]);
					}

					$this->db->insert(db_prefix() . 'rec_medical', [
						'candidate' => $insert_id,
						'medical_test_date' => $medical_test_date[$key],
						'valid_test_date' => $valid_test_date[$key],
						'medical_test_division' => $medical_test_division[$key],
						'judgement_y_n' => $judgement_y_n[$key],
						'medical_hospital' => $medical_hospital[$key],
						'judgement' => $judgement[$key],
						'final_option' => $final_option[$key],
						'medical_remark' => $medical_remark[$key],
					]);
				}
			}

			foreach ($vessel_name_company as $key => $val) {
				if ($vessel_name_company[$key] != '') {

					// if (!$this->check_format_date($val)) {
					// 	$val = to_sql_date($val);
					// }

					if (!$this->check_format_date($embarkation_date[$key])) {
						$embarkation_date[$key] = to_sql_date($embarkation_date[$key]);
					}

					if (!$this->check_format_date($disembarkation_date[$key])) {
						$disembarkation_date[$key] = to_sql_date($disembarkation_date[$key]);
					}


					$this->db->insert(db_prefix() . 'rec_on_board_company', [
						'candidate' => $insert_id,
						'vessel_name' => $vessel_name_company[$key],
						'grade_rank' => $grade_rank_board[$key],
						'rank' => $company_rank[$key],
						'vessel_type' => $vessel_type_company[$key],
						'gross_ton' => $gross_ton_company[$key],
						'engine_type' => $engine_type_company[$key],
						'eng_output' => $eng_output_company[$key],
						'embarkation_date' => $embarkation_date[$key],
						'disembarkation_date' => $disembarkation_date[$key],
						'boarding_period' => $boarding_period[$key],
						'ramaining_days' => $ramaining_days[$key],
						'calculation_y_n' => $calculation_y_n[$key],
						'emp_no' => $emp_no[$key],
						'cur_onboard' => ($cur_onboard[$key] == 'on') ? 1 : 0,
						'employment' => $employment[$key],
						'ship_owner' => $ship_owner[$key],
						'employer' => $employer_on_borad[$key],
					]);
				}
			}

			foreach ($other_rank as $key => $val) {
				if ($other_rank[$key] != '') {
					...
					if (!$this->check_format_date($embarkation_other_date[$key])) {
						$embarkation_other_date[$key] = to_sql_date($embarkation_other_date[$key]);
					}

					if (!$this->check_format_date($disembarkation_other_date[$key])) {
						$disembarkation_other_date[$key] = to_sql_date($disembarkation_other_date[$key]);
					}

					$this->db->insert(db_prefix() . 'rec_on_board_other_company', [
						'candidate' => $insert_id,
						'rank' => $other_rank[$key],
						'company_name' => $company_name_other[$key],
						'vessel_name' => $vessel_name_other[$key],
						'vessel_type' => $vessel_type_other[$key],
						'gross_ton' => $gross_ton_other[$key],
						'engine_type' => $engine_type_other[$key],
						'eng_output' => $eng_output_other[$key],
						'sailing_area' => $sailing_area[$key],
						'embarkation_date' => $embarkation_other_date[$key],
						'disembarkation_date' => $disembarkation_other_date[$key],
						'boarding_period' => $boarding_other_period[$key],
						'approval_rate' => $approval_rate[$key],
						'cur_onboard' => ($cur_other_onboard[$key] == 'on') ? 1 : 0,
						'remark' => $other_remark[$key],
					]);
				}
			}

			foreach ($company_name_land as $key => $val) {
				if ($company_name_land[$key] != '') {

					// if (!$this->check_format_date($val)) {
					// 	$val = to_sql_date($val);
					// }

					if (!$this->check_format_date($resignation_date[$key])) {
						$resignation_date[$key] = to_sql_date($resignation_date[$key]);
					}

					if (!$this->check_format_date($hire_date[$key])) {
						$hire_date[$key] = to_sql_date($hire_date[$key]);
					}


					$this->db->insert(db_prefix() . 'rec_on_board_in_land', [
						'candidate' => $insert_id,
						'company_name' => $company_name_land[$key],
						'hire_date' => $hire_date[$key],
						'resignation_date' => $resignation_date[$key],
						'work_dep' => $work_dep[$key],
						'responsibility_work' => $responsibility_work[$key],
						'final_position' => $final_position[$key],
						'retire_reason' => $retire_reason[$key],
						'other_company_career' => $other_company_career[$key],
						'remark' => $on_board_remark[$key],
					]);
				}
			}
	...
	public function update_education_info_cadidate($data, $id)
	{
		...
		$updated['edu_date'] = to_sql_date($data['edit_edu_date']);
	...
	public function add_family_info_cadidate($data)
	{
		...
		if ($candidateid != '') {
			$this->db->insert(db_prefix() . 'rec_family', [
				...
				'position' => $data['edit_family_grade'],
	...
	public function add_education_info_cadidate($data)
	{
		...
		if ($candidateid != '') {
			$this->db->insert(db_prefix() . 'rec_education', [
				...
				'edu_date' => to_sql_date($data['edu_date']),
	...
	public function update_cadidate($data, $id, $file = "")
	{
		...
		if (isset($data['reward_file_name'])) {
			$reward_file_name = $data['reward_file_name'];
			unset($data['reward_file_name']);
		}

		if (isset($data['licence_attach_file_name'])) {
			$licence_attach_file_name = $data['licence_attach_file_name'];
			unset($data['licence_attach_file_name']);
		}

		if (isset($data['doc_attach_file_name'])) {
			$doc_attach_file_name = $data['doc_attach_file_name'];
			unset($data['doc_attach_file_name']);
		}
			...
			if (isset($data['flag_attach_file_name'])) {
				$flag_attach_file_name = $data['flag_attach_file_name'];
				unset($data['flag_attach_file_name']);
			}
			...
			if ($app_date[$key] != '') {
				...
				if (!empty($file['reward_file']['tmp_name'][$key]) && $file['reward_file']['tmp_name'][$key] != '') {
					...
					$this->db->insert(db_prefix() . 'rec_reward', [
						...
						'award_punishment_kind' => $award_punishment_kind[$key],
						'award_punishment_reason' => $award_punishment_reason[$key],
						'reward_file' => $reward_file_name[$key],
						'rewards_remark' => $rewards_remark[$key],
					]);
				}
			}
			...
			if ($lic_acquisition_date[$key] != '') {
				...
				if (!empty($file['licence_attach_file']['tmp_name'][$key]) && $file['licence_attach_file']['tmp_name'][$key] != '') {
					...
					$this->db->insert(db_prefix() . 'rec_licence', [
						...
						'exipiry_date' => $lic_exipiry_date[$key],
						'issue_authority' => $lic_issue_authority[$key],
						'attach_file' => $licence_attach_file_name[$key],
						'remark' => $licence_remark[$key],
					]);
				}
			}
				...
				if (!empty($file['doc_attach_file']['tmp_name'][$key]) && $file['doc_attach_file']['tmp_name'][$key] != '') {
					...
					if (move_uploaded_file($tmpFilePath, $newFilePath)) {
						...
						$this->db->insert(db_prefix() . 'rec_document', [
							...
							'exipiry_date' => $doc_exipiry_date[$key],
							'issue' => $doc_issue_authority[$key],
							'attach_file' => $doc_attach_file_name[$key],
							'remark' => $doc_remark[$key],
						]);
				}
			}
				...
				if (!empty($file['flag_attach_file']['tmp_name'][$key]) && $file['flag_attach_file']['tmp_name'][$key] != '') {
					...
					if (move_uploaded_file($tmpFilePath, $newFilePath)) {
						...
						$this->db->insert(db_prefix() . 'rec_flag', [
							...
							'exipiry_date' => $flag_exipiry_date[$key],
							'issue' => $flag_issue_authority[$key],
							'attach_file' => $flag_attach_file_name[$key],
							'remark' => $flag_remark[$key],
						]);
				}
			}
		...
		$this->db->where('candidate', $id);
		$this->db->delete('rec_on_board_company');
		foreach ($vessel_name_company as $key => $val) {
			if ($vessel_name_company[$key] != '') {
		...
		$this->db->where('candidate', $id);
		$this->db->delete('rec_on_board_other_company');
		foreach ($other_rank as $key => $val) {
			if ($other_rank[$key] != '') {
		...
		$this->db->where('candidate', $id);
		$this->db->delete('rec_on_board_in_land');
