...
<style>
	...
	.nav-tabs .active{
		border: 2px solid #82a6f3 !important;
		border-bottom: 0px solid #82a6f3 !important;
	}
	.nav-tabs{
		border-bottom: 2px solid #82a6f3 !important;
	}
</style>
<div id="wrapper">
	<div class="content">
				...
				<div class="col-md-12">
					<div class="row">
						...
						<div class="col-md-8" style="text-align: center;">
							<p style="color: red;" class="bold">Payroll Information: &nbsp;
								<?php
								...
								$payroll_rate_per_principal = isset($candidate_payroll_selection_detail['payroll_rate_per_principal']) ? $candidate_payroll_selection_detail['payroll_rate_per_principal'] : '';

								$payroll_rate_per_principal_data = get_payroll_rate_per_principal($payroll_rate_per_principal);
								$payroll_rate_per_principal_vessel_group_name = '';
								if (!empty($payroll_rate_per_principal_data) && isset($payroll_rate_per_principal_data['vessel_group_name'])) {
									$payroll_rate_per_principal_vessel_group_name = $payroll_rate_per_principal_data['vessel_group_name'];
								}
								?>

								<?php
								echo '<span title="Payroll Data" style="color: red;">' . $payroll_vessel . ' - ( ' . $payroll_rank . ' ) - ' . $payroll_rate_per_principal_vessel_group_name . '</span>';
								?>
							</p>
						</div>
						<div class="col-md-2">
					...
					?>
					<!-- <h4 class="bold col-md-5" style="padding-left: 0px;"> -->
					<?php // echo '<span style="color: red;">#' . $candidate->candidate_code . '</span> - ' . $candidate->candidate_name . ' ' . $candidate->last_name; 
					?>
					<!-- <span>EMP: <?php // echo '<span style="color: red;">#' . $candidate->candidate_code . '</span>'; 
									?></span> -->
					<!-- </h4> -->
					...
					<div class="col-sm-12" style="padding: 0px;">
						<table class="table table-bordered">
							<tr>
								<td><span style="font-weight: 800;">EMP:</span> <?php echo $candidate->candidate_code; ?></td>
								<td colspan="2"><span style="font-weight: 800;">Name:</span>
									<?php echo html_entity_decode($candidate->candidate_name . ' ' . $candidate->last_name); ?>
								</td>
								<td><span style="font-weight: 800;">Age:</span>
									<?php echo html_entity_decode(calculateAge($candidate->birthday)); ?>
								</td>
								<td><span style="font-weight: 800;">DOB:</span> <?php echo _d($candidate->birthday); ?></td>
								<td><span style="font-weight: 800;">Hired Date:</span><?php echo _d($candidate->hired_date); ?></td>
								<td><span style="font-weight: 800;">Total Onboard Career:</span>
									<span class="total_hire_career"></span>
								</td>
							</tr>
							<tr>
								<td rowspan="4" style="text-align: center;">
									<!-- <div class="picture-container">
										<div class="picture"> -->
									<img height="150px" width="150px" src="<?php if (isset($candidate->avar)) {
								...
								<td colspan="3">
									<span style="font-weight: 800;">Address 1:</span>
									<span>
										<?php $resident = (isset($candidate) ? $candidate->resident : ''); ?>
										<?php echo $resident; ?>&nbsp;&nbsp;&nbsp;<?php echo get_select_option_name_by_id('cities_new', $candidate->city, 'name'); ?>&nbsp;&nbsp;&nbsp;<?php echo get_select_option_name_by_id('states_new', $candidate->state, 'name'); ?>&nbsp;&nbsp;&nbsp;<?php echo get_select_option_name_by_id('countries_new', $candidate->address_country, 'name'); ?>
									</span>
								</td>
								<!-- <td colspan="2">address 2</td> -->
								<td><span style="font-weight: 800;">Gender:</span>
									<?php echo ucfirst(strtolower(html_entity_decode($candidate->gender))); ?>
								</td>
								<td><span style="font-weight: 800;">Hired Career:</span>
									<span class="main_hire_career"></span>
								</td>
								<td><span style="font-weight: 800;">Current Rank Career: </span>
									<?php
									echo current_rank_career($candidate->id);
									?>
								</td>
							</tr>
							<tr>
								<td colspan="3"><span style="font-weight: 800;">Address 2: </span>
									<span>
										<?php $resident = (isset($candidate) ? $candidate->resident_2 : ''); ?>
										<?php echo $resident; ?>&nbsp;&nbsp;&nbsp;<?php echo get_select_option_name_by_id('cities_new', $candidate->city_2, 'name'); ?>&nbsp;&nbsp;&nbsp;<?php echo get_select_option_name_by_id('states_new', $candidate->state_2, 'name'); ?>&nbsp;&nbsp;&nbsp;<?php echo get_select_option_name_by_id('countries_new', $candidate->address_country_2, 'name'); ?>
									</span>
								</td>
								<td><span style="font-weight: 800;">Religion:</span>
									<?php echo html_entity_decode($candidate->religion); ?>
								</td>
								<td><span style="font-weight: 800;">Other Career: </span><span class="other_hire_career"></span></td>
								<td><span style="font-weight: 800;">Other Rank Career</span></td>
							</tr>
							<tr>
								<td><span style="font-weight: 800;">Mobile</span></td>
								<td><span style="font-weight: 800;">Home</span></td>
								<td><span style="font-weight: 800;">Emergency</span></td>
								<td><span style="font-weight: 800;">E-mail: </span>
									<?php
									echo $candidate->email;
									?>
								</td>
								<td><span style="font-weight: 800;">Civil</span></td>
								<td><span style="font-weight: 800;">Family</span></td>
							</tr>
							<tr>
								<td colspan="4"><span style="font-weight: 800;">Social:</span>
									&nbsp;
									<?php
									$facebook_url = trim($candidate->facebook);
									if (!empty($facebook_url)) {
										echo '<a href="' . $facebook_url . '" target="_blank" rel="noopener noreferrer">
            									<i class="fa-brands fa-facebook"></i>
          									  </a>';
									}
									?>
								</td>
								<td><span style="font-weight: 800;">School</span></td>
								<td><span style="font-weight: 800;">Course</span></td>
							</tr>
							<tr>
								<td><span style="font-weight: 800;">Rank: </span>
									<?php $camption_name = get_camption_name($candidate->rank); ?>
									<?php echo isset($camption_name->rank_name) ? $camption_name->rank_name : '' ?>
								</td>
								<td><span style="font-weight:800; cursor: pointer;" class="editable-field"
										data-field="uniform_height"
										data-value="<?php echo html_escape($candidate->uniform_height); ?>"
										data-label="Height"
										data-field_type="number"
										style="cursor:pointer;">Height: </span>
									<?php
									if ($candidate->uniform_height != '' && $candidate->uniform_height > 0) {
										echo $candidate->uniform_height . ' cm';
									}
									?>
								</td>
								<td><span style="font-weight:800; cursor: pointer;" class="editable-field"
										data-field="weight"
										data-value="<?php echo html_escape($candidate->weight); ?>"
										data-label="Weight"
										data-field_type="number"
										style="cursor:pointer;">Weight: </span>
									<?php
									if ($candidate->weight != '' && $candidate->weight > 0) {
										echo $candidate->weight . ' KG';
									}
									?>
								</td>
								<td><span style="font-weight:800; cursor: pointer;" class="editable-field"
										data-field="uniform_waist"
										data-value="<?php echo html_escape($candidate->uniform_waist); ?>"
										data-label="Waist"
										data-field_type="number"
										style="cursor:pointer;">Waist: </span>
									<?php
									if ($candidate->uniform_waist != '' && $candidate->uniform_waist > 0) {
										echo $candidate->uniform_waist . ' inches';
									}
									?>
								</td>
								<td><span style="font-weight:800; cursor: pointer;" class="editable-field"
										data-field="uniform_shoes"
										data-value="<?php echo html_escape($candidate->uniform_shoes); ?>"
										data-label="Shoes"
										data-field_type="number"
										style="cursor:pointer;">Shoes: </span>
									<?php
									if ($candidate->uniform_shoes != '' && $candidate->uniform_shoes > 0) {
										echo $candidate->uniform_shoes . ' mm';
									}
									?>
								</td>
								<!-- <td><span style="font-weight: 800;">Working Gears: </span><?php echo $candidate->uniform_working_gears; ?></td> -->
								<td>
									<span style="font-weight:800; cursor: pointer;" class="editable-field"
										data-field="uniform_working_gears"
										data-value="<?php echo html_escape($candidate->uniform_working_gears); ?>"
										data-label="Working Gears"
										data-field_type="text"
										style="cursor:pointer;">Working Gears:</span>

									<span>
										<?php echo $candidate->uniform_working_gears; ?>
									</span>
								</td>
								<td><span style="font-weight: 800;">Vessel Name:</span>
									<?php
									$candidate_payroll_selection_detail = get_candidate_payroll_selection_detail($candidate->id);
									$payroll_vessel = isset($candidate_payroll_selection_detail['vessel']) ? ' ( ' . $candidate_payroll_selection_detail['vessel'] . ' )' : '';
									?>
									<?php echo get_select_option_name_by_id('job_department', $candidate->department, 'department_name') . '<span title="Payroll Data" style="color: red;">' . $payroll_vessel . '</span>'; ?>
								</td>
							</tr>
						</table>
					</div>
				...
				<div class="col-md-12">
					...
					<div class="tab-content">
						...
						<div role="tabpanel" class="tab-pane active" id="detail">
							<!-- new sub menu system for summury tab -->
							<ul class="nav nav-tabs" role="tablist" style="margin-top:15px; display: flex; justify-content: center;">
								<!-- <li role="presentation" class="active">
									<a href="#sub_tab_general_information" aria-controls="sub_tab_general_information" role="tab" data-toggle="tab" style="font-weight: bold;">
										1. General Information
									</a>
								</li> -->
								<li role="presentation" class="active">
									<a href="#sub_tab_emergency_contact_person" aria-controls="sub_tab_emergency_contact_person" role="tab" data-toggle="tab" style="font-weight: bold;">
										1. Emergency Contact Person
									</a>
								</li>
								<li role="presentation">
									<a href="#sub_tab_travel_and_identification_documents" aria-controls="sub_tab_travel_and_identification_documents" role="tab" data-toggle="tab" style="font-weight: bold;">
										2. Travel and Identification Documents
									</a>
								</li>
								<li role="presentation">
									<a href="#sub_tab_school_information" aria-controls="sub_tab_school_information" role="tab" data-toggle="tab" style="font-weight: bold;">
										3. School Information
									</a>
								</li>
								<li role="presentation">
									<a href="#sub_tab_other_info" aria-controls="sub_tab_other_info" role="tab" data-toggle="tab" style="font-weight: bold;">
										4. Other Information
									</a>
								</li>
								<li role="presentation">
									<a href="#sub_tab_seniority" aria-controls="sub_tab_seniority" role="tab" data-toggle="tab" style="font-weight: bold;">
										5. Seniority
									</a>
								</li>
								<li role="presentation">
									<a href="#sub_tab_literacy" aria-controls="sub_tab_literacy" role="tab" data-toggle="tab" style="font-weight: bold;">
										6. Literacy
									</a>
								</li>
								<li role="presentation">
									<a href="#sub_tab_reference" aria-controls="sub_tab_reference" role="tab" data-toggle="tab" style="font-weight: bold;">
										7. Reference
									</a>
								</li>
							...
							<div class="tab-content" style="padding-top:15px;">
								<div role="tabpanel" class="tab-pane hide" id="sub_tab_general_information">
									<div class="col-md-1 padding-left-right-0 margin-top-15" style="padding-right: 10px;">
									...
									<div class="col-md-6 padding-left-right-0">
										<table class="table border table-striped margin-top-0 project_view_table">
											<tbody>
												...
												<tr class="project-overview">
													<td colspan="2" style="padding: 0px;">
														<table class="table" width="100%" style="margin-top: 0px; margin-bottom: 0px;">
															<tr>
																<td width="25%"><strong><?php echo _l('nationality'); ?></strong></td>
																<td width="25%"><?php echo html_entity_decode($candidate->nationality); ?></td>
																<td width="25%"><strong><?php echo _l('gender'); ?></strong></td>
																<td width="25%" style="color: black; font-weight: 600;"><?php echo html_entity_decode($candidate->gender); ?></td>
															</tr>

															<tr style="background:#f8fafc !important;">
																<td><strong><?php echo _l('birthday'); ?></strong></td>
																<td><?php echo _d($candidate->birthday); ?></td>
																<td><strong><?php echo _l('age'); ?></strong></td>
																<td style="color: black; font-weight: 600;"><?php echo html_entity_decode(calculateAge($candidate->birthday)); ?></td>
															</tr>

															<tr>
																<td><strong><?php echo _l('marital_status'); ?></strong></td>
																<td><?php echo _l($candidate->marital_status); ?></td>
																<td><strong><?php echo _l('religion'); ?></strong></td>
																<td style="color: black; font-weight: 600;"><?php echo html_entity_decode($candidate->religion); ?></td>
															</tr>

															<tr style="background:#f8fafc !important;">
																<td><strong>Height</strong></td>
																<td><?php echo _l($candidate->uniform_height); ?></td>
																<td><strong>Waist</strong></td>
																<td style="color: black; font-weight: 600;"><?php echo _l($candidate->uniform_waist); ?></td>
															</tr>

															<tr>
																<td><strong>Working Gears</strong></td>
																<td><?php echo _d($candidate->uniform_working_gears); ?></td>
																<td><strong>Shoes</strong></td>
																<td style="color: black; font-weight: 600;"><?php echo _d($candidate->uniform_shoes); ?></td>
															</tr>
														</table>
													</td>
												</tr>
												...
												<tr class="project-overview">
													<td style="color: red;" class="bold">Payroll Information</td>
													<?php
													$candidate_payroll_selection_detail = get_candidate_payroll_selection_detail($candidate->id);
													$payroll_vessel = isset($candidate_payroll_selection_detail['vessel']) ?  $candidate_payroll_selection_detail['vessel'] : '';
										...
										<table class="table border table-striped margin-top-0 project_view_table">
											<tbody>
												...
												<tr class="project-overview">
													...
													<td>
														<?php
														$candidate_on_board_company = (isset($candidate) ? $candidate->on_board_company : '');
														if (!empty($candidate_on_board_company)) {
															foreach ($candidate_on_board_company as $key => $value) {
																if ($value['cur_onboard'] == 1) {
																	$principal_employer = $value['employer'];
																	$principal_employer_data = custom_filed_setting_principals($principal_employer);
																	$principal_employer_name = '';
																	if (isset($principal_employer_data) && !empty($principal_employer_data)) {
																		$principal_employer_name = $principal_employer_data['principal_name'];
																	}
																	break;
																}
															}
														}
														echo $principal_employer_name;
														?>
													</td>
												</tr>
								...
								<div role="tabpanel" class="tab-pane active" id="sub_tab_emergency_contact_person">
								...
								<div role="tabpanel" class="tab-pane" id="sub_tab_travel_and_identification_documents">
									<div class="col-md-12">
								...
								<div role="tabpanel" class="tab-pane" id="sub_tab_school_information">
								...
								<div role="tabpanel" class="tab-pane" id="sub_tab_other_info">
									<div class="col-md-6 padding-left-right-0">
										<table class="table border table-striped margin-top-0 project_view_table">
											<tbody>
								...
								<div role="tabpanel" class="tab-pane" id="sub_tab_seniority">
								...
								<div role="tabpanel" class="tab-pane" id="sub_tab_literacy">
								...
								<div role="tabpanel" class="tab-pane" id="sub_tab_reference">
						...
						<div role="tabpanel" class="tab-pane" id="licence_document_info">
							...
							<ul class="nav nav-tabs" role="tablist" style="margin-top:15px;">
								<li role="presentation" class="active">
									<a href="#sub_tab_travel_lable_admin" aria-controls="sub_tab_travel_lable_admin" role="tab" data-toggle="tab" style="font-weight: bold;">
										<?php echo get_option('travel_lable_admin'); ?>
									</a>
								</li>
								<li role="presentation">
									<a href="#sub_tab_other_licence_lable_admin" aria-controls="sub_tab_other_licence_lable_admin" role="tab" data-toggle="tab" style="font-weight: bold;">
										<?php echo get_option('other_licence_lable_admin'); ?>
									</a>
								</li>
								<li role="presentation">
									<a href="#sub_tab_licence_3_lable_admin" aria-controls="sub_tab_licence_3_lable_admin" role="tab" data-toggle="tab" style="font-weight: bold;">
										<?php echo get_option('licence_3_lable_admin'); ?>
									</a>
								</li>
								<li role="presentation">
									<a href="#sub_tab_licence_4_lable_admin" aria-controls="sub_tab_licence_4_lable_admin" role="tab" data-toggle="tab" style="font-weight: bold;">
										<?php echo get_option('licence_4_lable_admin'); ?>
									</a>
								</li>

								<li role="presentation">
									<a href="#sub_tab_licence_5_lable_admin" aria-controls="sub_tab_licence_5_lable_admin" role="tab" data-toggle="tab" style="font-weight: bold;">
										<?php echo get_option('licence_5_lable_admin'); ?>
									</a>
								</li>

								<li role="presentation">
									<a href="#sub_tab_licence_6_lable_admin" aria-controls="sub_tab_licence_6_lable_admin" role="tab" data-toggle="tab" style="font-weight: bold;">
							...
							<div class="tab-content" style="padding-top:15px;">
								<div role="tabpanel" class="tab-pane active" id="sub_tab_travel_lable_admin">
									<div class="checkbox checkbox-primary" style="font-size: 18px; margin-bottom: 10px;">
								...
								<div role="tabpanel" class="tab-pane" id="sub_tab_other_licence_lable_admin">
									<div class="checkbox checkbox-primary" style="font-size: 18px; margin-bottom: 10px;">
								...
								<div role="tabpanel" class="tab-pane" id="sub_tab_licence_3_lable_admin">
									<div class="checkbox checkbox-primary" style="font-size: 18px; margin-bottom: 10px;">
									...
									<?php if (count($candidate->rec_licence_3) > 0) { ?>
										<table class="table dt-table  margin-top-0 licence_3_document" data-order-col="1" data-order-type="asc">
											<thead>
												<th width="2%" title="The checked data will be used to create the contract.">Mark</th>
												<th width="3%"><?php echo _l('no'); ?></th>
												<th width="15%"><?php echo _l('document_type'); ?></th>
												<th width="14%"><?php echo _l('licence_no'); ?></th>
												<th width="4%"><?php echo _l('acquisition_date'); ?></th>
												<th width="4%"><?php echo _l('expiry_date'); ?></th>
												<th width="9%"><?php echo _l('issue_authority'); ?></th>
												<th width="2%"><?php echo _l('attach_file'); ?></th>
											...
											<tbody>
												...
												?>
													<tr class="project-overview-4 <?php echo ($welicence_3['hideexpire'] == 1) ? 'hidden-expire3' : ''; ?>" data-expiry-status="<?php echo $expiry_licenece_3_status; ?>">
														...
														<td>
															<?php
															$checked = $welicence_3['mark'] == 1 ? "checked" : '';
															?>
															<input type="checkbox" name="mark" class="licenece_3_mark_checkbox" value="1" <?php echo $checked; ?> data-tr_id="<?php echo $welicence_3['tr_id']; ?>">
														</td>
								...
								<div role="tabpanel" class="tab-pane" id="sub_tab_licence_4_lable_admin">
									<div class="checkbox checkbox-primary" style="font-size: 18px; margin-bottom: 10px;">
								...
								<div role="tabpanel" class="tab-pane" id="sub_tab_licence_5_lable_admin">
									<div class="checkbox checkbox-primary" style="font-size: 18px; margin-bottom: 10px;">
								...
								<div role="tabpanel" class="tab-pane" id="sub_tab_licence_6_lable_admin">
									<div class="checkbox checkbox-primary" style="font-size: 18px; margin-bottom: 10px;">
									...
									<tbody>
										...
										foreach ($candidate->on_board_company as $we) { ?>
											<tr class="project-overview">
												...
												<td>
													<?php
													$employee_value = trim($we['employer']);

													if (is_numeric($employee_value)) {

														// New data → stored as ID
														$principal_detail = custom_filed_setting_principals($employee_value);

														echo html_entity_decode(
															isset($principal_detail['principal_name'])
																? $principal_detail['principal_name']
																: ''
														);
													} else {

														// Old data → already stored as name
														echo html_entity_decode($employee_value);
													}
													?>
												</td>
												<td class="text-center">
		...
		<div class="modal-content width-100">
			...
			<div class="modal-body">
				<div class="row" style="display: flex; justify-content: center; flex-wrap: wrap;">
					...
					<div class="col-md-6">
						<?php
						$contract_duration_data = contract_duration_data_get();
						echo render_select('contract_duration', $contract_duration_data, ['id', 'name'], _l('contract_duration'), '');
						?>
					</div>
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-6">
						...
						?>
						<?php
						$custom_filed_setting_principals = custom_filed_setting_principals();
						echo render_select('employer', $custom_filed_setting_principals, ['id', 'principal_name'], 'employer', '', ['data-actions-box' => true], [], '', '', false);
						?>
					</div>
				</div><!-- /.row -->
			</div><!-- /.modal-body -->
...
<div class="modal fade" id="edit_field_modal">
	<div class="modal-dialog">
		<div class="modal-content">
			<?php echo form_open_multipart(admin_url('recruitment/quick_edit_crew_detail')); ?>
			...
			<div class="modal-body">
				<div class="form-group field_input_box">
					<label for="" class="control-label"></label>
					<input type="" id="" name="" class="form-control" value="">
				</div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal"> Close</button>
				<button type="submit" class="btn btn-primary" id="save_field">Save</button>
			</div>
...
<script>
	$(document).ready(function() {
		...
		appValidateForm($('#add_contract-form'), {
...
<script>
	...
	$(document).on("change", "#contract_template", function() {
		var id = $(this).val();
		var contract_duration = $("#contract_duration").val();
		if (contract_duration === "") {
			$("select[name='contract_template']").selectpicker('destroy');
			$("select[name='contract_template']").val('');
			$("select[name='contract_template']").selectpicker('refresh');
			alert_float("danger", "Input Contract Duration and save first  before slect Contract Template.");
			return;
		}
	...
	// $(document).on('change', '.licenece_3_mark_checkbox', function() {
	// 	if ($(this).is(':checked')) {
	// 		$('.licenece_3_mark_checkbox').not(this).prop('checked', false);
	...
	$(document).on('change', '.licenece_3_mark_checkbox', function() {
		...
		if ($this.is(':checked')) {
			...
			if (tr_id > 0) {
				...
				$.ajax({
					url: admin_url + "recruitment/update_licence_3_mark",
					type: "POST",
					dataType: "json",
					data: {
						tr_id: tr_id
	...
	$(document).on('click', '.editable-field', function() {
		$(".field_input_box .control-label").text($(this).data('label'));
		$(".field_input_box input").attr('type', $(this).data('field_type'));
		$(".field_input_box input").attr('id', $(this).data('field'));
		$(".field_input_box input").attr('name', $(this).data('field'));
		$(".field_input_box input").val($(this).data('value'));
