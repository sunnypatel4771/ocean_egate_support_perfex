                    ...
                    <div class="row col-md-12" id="general_information">
                      ...
                      <div class="col-md-9">
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            <?php $middle_name = (isset($candidate) ? $candidate->middle_name : '');
                            echo render_input('middle_name', 'middle_name', $middle_name) ?>
                          </div>
                      ...
                      <div class="col-md-9">
                        <p style="font-weight: bold;">Address #1</p>
                        <hr style="padding: 0; margin: 0; border: 1px solid black; margin-bottom: 10px;">
                        <div class="row">
                          <div class="col-md-3">
                            <?php $selected_country = isset($candidate) ? $candidate->address_country : 0;
                            echo render_select('address_country', !empty($countries) ? $countries : [], ['id', 'name'], 'Region', isset($selected_country) ? $selected_country : '');
                      ...
                      <div class="col-md-9">
                        <p style="font-weight: bold;">Address #2</p>
                        <hr style="padding: 0; margin: 0; border: 1px solid black; margin-bottom: 10px;">
                        <div class="row">
                          <div class="col-md-3">
                            <?php $selected_country = isset($candidate) ? $candidate->address_country_2 : 0;
                            echo render_select('address_country_2', !empty($countries) ? $countries : [], ['id', 'name'], 'Region', isset($selected_country) ? $selected_country : '');
                            ?>
                          </div>

                          <div class="col-md-3">
                            <?php
                            $selected_state = isset($candidate) ? $candidate->state_2 : 0;
                            ?>
                            <input type="hidden" id="seelcted_state_value_2" value="<?php echo $selected_state; ?>" />
                            <?php echo render_select('state_2', isset($edit_states) ? $edit_states : [], ['id', 'name'], 'Province', $selected_state); ?>
                          </div>

                          <div class="col-md-3">
                            <?php $selected_city = isset($candidate) ? $candidate->city_2 : 0; ?>
                            <input type="hidden" id="seelcted_city_value_2" value="<?php echo $selected_city; ?>" />
                            <?php echo render_select('city_2', isset($edit_cities) ? $edit_cities : [], ['id', 'name'], 'Municipality / City', $selected_city); ?>
                          </div>

                          <div class="col-md-3">
                            <?php
                            $resident = (isset($candidate) ? $candidate->resident_2 : '');
                            echo render_input('resident_2', 'resident', $resident); ?>
                          </div>
                        </div>
                      </div>
                ...
                <div class="panel-body">
                  <div class="uniform">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <?php
                        $uniform_height = (isset($candidate) ? $candidate->uniform_height : '');
                        // this value in fload like 85.6
                        echo render_input('uniform_height', 'Height', $uniform_height, 'number', array('step' => '0.01'));
                        ?>
                      </div>

                      <div class="col-sm-3">
                        <?php
                        $uniform_waist = (isset($candidate) ? $candidate->uniform_waist : '');
                        // this value in fload like 85.6
                        echo render_input('uniform_waist', 'Waist', $uniform_waist, 'number', array('step' => '0.01'));
                        ?>
                      </div>

                      <div class="col-sm-3">
                        <?php
                        $uniform_working_gears = (isset($candidate) ? $candidate->uniform_working_gears : '');
                        echo render_input('uniform_working_gears', 'Working Gears', $uniform_working_gears);
                        ?>
                      </div>

                      <div class="col-sm-3">
                        <?php
                        $uniform_shoes = (isset($candidate) ? $candidate->uniform_shoes : '');
                        // this value in fload like 85.6
                        echo render_input('uniform_shoes', 'Shoes', $uniform_shoes, 'number', array('step' => '0.01'));
                        ?>
                      </div>
                      ...
                      <div class="row" id="personal_information">
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="col-md-3">
                            ...
                            echo render_input('employer', 'employer', $principal_employer_name, '', ['readonly' => true]); ?>
                          </div>
                        </div>
                        <div class="col-md-12">
                          <div class="col-md-3">
